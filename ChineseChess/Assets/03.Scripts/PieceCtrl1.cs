...
public class PieceCtrl1 : MonoBehaviour
{
                ...
                switch (ob_tag)
                {
                    ...
                    case "Coordinate":
                        if (flag == 0)
                        {
                            ...
                            {
                                case "red_bing(Clone)":
                                    if(Red_BingMove(gameObj, hitInfo))
                                    {
                                        exchange = 1;
                                    }
                                    ...
                                    break;
                                case "red_shi(Clone)":
                                    if(Red_ShiMove(gameObj, hitInfo))
                                    {
                                        exchange = 1;
                                    }
                                    //Debug.Log(piece_name);
                                ...
                                case "red_xiang(Clone)":
                                    if(Red_XiangMove(gameObj, hitInfo))
                                    {
                                        exchange = 1;
                                    }
                                    //Debug.Log(piece_name);
                                ...
                                case "red_che(Clone)":
                                    ...
                                    if (hitInfo_che.collider.gameObject.name == hitInfo.collider.gameObject.name)
                                    {
                                        ...
                                        if(Red_CheMove(gameObj, hitInfo))
                                        {
                                            exchange = 1;
                                        }
                                        //Debug.Log(piece_name);
                                ...
                                case "red_jiang(Clone)":
                                    if(Red_JiangMove(gameObj, hitInfo))
                                    {
                                        exchange = 1;
                                    }
                                    //Debug.Log(piece_name);
                                ...
                                case "red_pao(Clone)":
                                    ...
                                    if (hitInfo_pao.collider.gameObject.name == hitInfo.collider.gameObject.name)
                                    {
                                        ...
                                        if(Red_PaoMove(gameObj, hitInfo))
                                        {
                                            exchange = 1;
                                        }
                                        //Debug.Log(piece_name);
                        ...
                        if (flag == 0)
                        {
                            ...
                            switch (piece_name)
                            {
                                case "black_bing(Clone)":
                                    if(Black_BingMove(gameObj1, hitInfo))
                                    {
                                        exchange = 0;
                                    }
                                    //Debug.Log(piece_name);
                                ...
                                case "black_shi(Clone)":
                                    if (Black_ShiMove(gameObj1, hitInfo))
                                    {
                                        exchange = 0;
                                    }
                                        //Debug.Log(piece_name);
                                        break;
                                case "black_ma(Clone)":
                                    if(Black_MaMove(gameObj1, hitInfo))
                                    {
                                        exchange = 0;
                                    }
                                    //Debug.Log(piece_name);
                                ...
                                case "black_xiang(Clone)":
                                    if(Black_XiangMove(gameObj1, hitInfo))
                                    {
                                        exchange = 0;
                                    }
                                    break;
                                case "black_che(Clone)":
                                    ...
                                    if (hitInfo_che.collider.gameObject.name == hitInfo.collider.gameObject.name)
                                    {
                                        ...
                                        if(Black_CheMove(gameObj1, hitInfo))
                                        {
                                            exchange = 0;
                                        }
                                        //Debug.Log(piece_name);
                                ...
                                case "black_jiang(Clone)":
                                    Black_JiangMove(gameObj1, hitInfo);
                                    //Debug.Log(piece_name);
                                    break;
                                case "black_pao(Clone)":
                                    ...
                                    if (hitInfo_pao.collider.gameObject.name == hitInfo.collider.gameObject.name)
                                    {
                                        ...
                                        if(Black_PaoMove(gameObj1, hitInfo))
                                        {
                                            exchange = 0;
                                        }
                                        //Debug.Log(piece_name);
